...
from .models import (
    Insight, Keywords, ListingBrands, ListingCategory,
    Organization, Packages, Partner, Testimonial
)
...
class KeywordsSerializer(serializers.ModelSerializer):
    class Meta:
        model = Keywords
        fields = [
            'id', 'name', 'seo_title', 'seo_description', 'slug', 'section'
        ]
...
class ListingBrandsSerializer(serializers.ModelSerializer):
    class Meta:
        model = ListingBrands
        fields = [
            'id', 'name', 'seo_title', 'seo_description', 'slug'
        ]
...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Organization
        fields = [
            'user_username', 'password', 'user', 'package', 'logo',
            'banner', 'brochure', 'category', 'keywords', 'brands',
            'company_name', 'company_email', 'company_mobile',
            'company_fax', 'company_whatsapp', 'company_description',
            'address', 'building_no', 'street', 'area', 'po_box',
            'city', 'state', 'country', 'website', 'google_map_url',
            'iso', 'contact_person_name', 'contact_person_email',
            'contact_person_mobile', 'facebook', 'twitter',
            'linkedin', 'instagram', 'youtube', 'verified',
            'supplier', 'distributor', 'start_date', 'end_date',
            'slug', 'created_at', 'updated_at', 'package_id'
        ]
...
class CategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'organizations', 'id', 'name', 'image', 'slug',
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'last_name', 'email', 'organization_id'
        ]
...
class InsightSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Insight
        fields = [
            'organization', 'category', 'title', 'image',
            'description', 'created', 'updated', 'slug'
        ]
